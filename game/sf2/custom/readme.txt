...
For example, you might have the following file structure:
	...
	sf2/custom/my_custom_stuff/   <<< This subfolder will be added as a search path
	sf2/custom/my_custom_stuff/models/custom_model.mdl
	sf2/custom/my_custom_stuff/materials/custom_material.vmt
	sf2/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	sf2/custom/some_mod.vpk       <<< This VPK will be added as a search path
	sf2/custom/another_mod.vpk    <<< This VPK will be added as a search path
...
Note that the following directory structure is NOT correct:
	...
	sf2/custom/models/my_model.mdl

That will add the directory "sf2/custom/models" as a search path, in which case the
file my_model.mdl actually exists at the root of the game's virtual filesystem.
Instead, you would use something like:

	sf2/custom/my_custom_stuff/models/my_model.mdl
